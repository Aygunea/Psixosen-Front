...
const ExplorePage = () => {
  ...
  return (
    <div className='h-full grid grid-rows-[auto_1fr]'>
      ...
      <div className="flex justify-between xs:mx-6">
      <p className='dark:text-dark100 text-gray10 font-bold text-2xl xs:text-xl py-[26px]'>
        Kəşf et
      </p>
          <div className=' sm:hidden py-6 flex gap-3 justify-end'>
            <button
      ...
      <div className='py-9 xs:pt-0 xs:pb-8 bg-transparent sm:dark:bg-darkblack sm:bg-lightwhite rounded-[10px] h-full overflow-y-auto scrollbar'>
        <Outlet />
      </div>
    </div>
  )
