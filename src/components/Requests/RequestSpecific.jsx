...
const RequestSpecific = () => {
    ...
    useEffect(() => {
        ...
        socket.current.on('specific-request', (newRequest) => {
                            ...
                            {requests.map((request, rowIndex) => {
                                ...
                                return (
                                    <tr key={rowIndex} className='w-full grid grid-cols-[1fr_1.5fr_0.8fr_1.5fr_0.8fr_1fr_1fr]'>
                                        ...
                                        <td className='py-[11.5px] border-b border-light20 dark:border-darkgray flex items-center justify-center'>
                                            {request.status == "accepted" ? (
                                                <button
                                                    className='dark:bg-light70 bg-dark70 w-[80px] rounded-[5px] py-2 text-sm text-dark100'>
                                                    Başla
                                                </button>
                                                ...
                                                <button
                                                    ...
                                                    className='dark:bg-green bg-lightgreen rounded-[5px] py-2 w-[80px] text-sm text-dark100'>
                                                    Qəbul et
                                                </button>
                                            )}
                                        </td>
