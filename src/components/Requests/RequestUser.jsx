                                    ...
                                    return (
                                        <tr key={rowIndex} className='w-full grid grid-cols-[1fr_1.5fr_0.8fr_1.5fr_0.8fr_1fr_1fr]'>
                                            ...
                                            <td className='py-[11.5px] border-b border-light20 dark:border-darkgray'>
                                                <button className={`${request.status === 'accepted' ? 'opacity-100' : 'opacity-30'} dark:bg-green rounded-[5px] py-2 px-[10px] xl:w-[100px] w-16 text-sm text-dark100`}>
                                                    Başla
                                                </button>
                                            </td>
                                        </tr>
                                        ...
                                        {show === rowIndex && (
                                            <div className="block">
                                                ...
                                                <div className="flex justify-center items-center mt-8">
                                                    <button className={`${request.status === 'accepted' ? 'opacity-100' : 'opacity-30'} dark:bg-green rounded-[5px] py-2 px-[10px] w-[100px] text-sm text-dark100`}>
                                                        Başla
                                                    </button>
                                                </div>
                                            </div>
